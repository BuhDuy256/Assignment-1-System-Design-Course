...
% ============================================================
% SLIDE 3 — CÁC GIẢI PHÁP THAY THẾ
% ============================================================
\begin{frame}[fragile]{Observer: Các giải pháp thay thế}
  \textbf{Giải pháp 1: Polling --- consumer tự hỏi source liên tục}
  \begin{itemize}
  ...
  \vspace{0.3em}
  \textbf{Giải pháp 2: Callback functions trực tiếp}
  \begin{itemize}
...
% ============================================================
% SLIDE 4.5 — CẤU TRÚC OBSERVER PATTERN
% ============================================================
\begin{frame}{Observer: Cấu trúc pattern}
  \begin{center}
    \includegraphics[width=0.95\textwidth]{images/observer-structure.png}
  \end{center}
\end{frame}
