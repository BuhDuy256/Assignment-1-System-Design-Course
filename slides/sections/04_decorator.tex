...
% ============================================================
% SLIDE 3 — GIẢI PHÁP NGÂY THƠ & TẠI SAO THẤT BẠI
% ============================================================
\begin{frame}[fragile]{Decorator: Những giải pháp ngây thơ}
  \begin{columns}[T]
    \begin{column}{0.52\textwidth}
      \textbf{Thử lần 1: Dùng boolean flags}
