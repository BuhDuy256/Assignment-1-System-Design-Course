...
class Coffee {
  ...
  \begin{itemize}
    \item Không được thiết kế để stacking linh hoạt
  \end{itemize}
\end{frame}
...
% ============================================================
% SLIDE 4.5 — CẤU TRÚC DECORATOR PATTERN
% ============================================================
\begin{frame}{Decorator: Cấu trúc pattern}
  \begin{center}
    \includegraphics[width=0.95\textwidth]{images/decorator-structure.png}
  \end{center}
\end{frame}
