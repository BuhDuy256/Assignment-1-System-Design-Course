...
\input{sections/02_factory.tex}

\input{sections/03_abstract_factory.tex}

\input{sections/04_decorator.tex}

\input{sections/05_adapter.tex}

\input{sections/06_observer.tex}
